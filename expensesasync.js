...
async function saveToCrud(event) {
    ...
    try{
    const response= await axios.post("https://crudcrud.com/api/623645b8f840497da08799414ab4acc1/expenses",obj)
...
window.addEventListener("DOMContentLoaded",()=>{
   async function reload(){
     try{
        const response = await axios.get("https://crudcrud.com/api/623645b8f840497da08799414ab4acc1/expenses")
...
async function deleteExpense(id) {
    try{
        const response = await axios.delete(`https://crudcrud.com/api/623645b8f840497da08799414ab4acc1/expenses/${id}`)
        console.log(response)
